                ...
                <div class="modal-body" style="margin-top: -20px">
                    <form action="" id="add_donor_form">
                            ...
                            <div class="col-lg-4 mt-2">
                                ...
                                <select class="form-control js-example-basic-single" name="division" id="division">
                                    ...
                                    @foreach ($divisions as $division)
                                        <option value="{{ $division->id }}" {{ $division->name=='Rangpur'?'selected':'' }}>{{ $division->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 mt-2">
                                <label for="user_email"><strong>{{ __('admin_local.Donor Date Of Birth') }} *</strong></label>
                            ...
                            <div class="col-lg-4 mt-2">
                                <label for="user_email"><strong>{{ __('admin_local.Last Donation Date') }} </strong></label>
                                <input type="date" class="form-control" name="last_donation_date" id="last_donation_date">
                            ...
                            <div class="col-lg-3 mt-2">
                                <label for="user_email"><strong>{{ __('admin_local.Is TMP Password') }} </strong></label><br>
                            ...
                            <div class="col-lg-8 mt-2">
                                <label for="user_phone"><strong>{{ __('admin_local.Last Donation Details') }} </strong></label>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-3">
                                    <button class="btn btn-success" type="btn" data-bs-toggle="modal"
                                        data-bs-target="#add-donor-modal">+ {{ __('admin_local.Add Blood Donor') }}</button>
                                </div>
                            </div>
                        @endif
